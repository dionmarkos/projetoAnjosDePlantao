...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('anjosDePlantaoAmbiente', '0002_auto_20190710_1405'),
    ]

    operations = [
        migrations.RemoveField(
            model_name='caixageral',
            name='tipoDoacaoDoacao',
        ),
        migrations.RemoveField(
            model_name='caixageral',
            name='tipoDoacaoRecebimento',
        ),
        migrations.RemoveField(
            model_name='caixageral',
            name='valor',
        ...
        migrations.AddField(
            model_name='caixageral',
            name='saldo',
            field=djmoney.models.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), default_currency='BRL', max_digits=11),
        ),
        migrations.AddField(
            model_name='caixageral',
            name='saldo_currency',
        ...
        migrations.AddField(
            model_name='doacao',
            name='pessoa',
            field=models.ForeignKey(default=2, on_delete=django.db.models.deletion.DO_NOTHING, to='anjosDePlantaoAmbiente.Pessoa'),
